...
//
// Algorithm v3 produces one maximal finding per clone rather than one finding
// per overlapping MinTokens window. It chains aligned seed matches across different
// token fingerprints and groups by (left path, right path, offset).
