			...
			wantDiags: []wantDiag{
				{
					...
					MessageSubstr: "must be a non-empty path",
				},
			},
		},
		{
			...
			wantDiags: []wantDiag{
				{
					...
					Code:          PlanCodePathPolicyViolation,
					Keyword:       KeywordPathPolicy,
					MessageSubstr: "must not be an absolute path (no leading separator)",
				},
			},
		},
		{
			...
			wantDiags: []wantDiag{
				{
					...
					Code:          PlanCodePathPolicyViolation,
					Keyword:       KeywordPathPolicy,
					MessageSubstr: "must not contain a parent-traversal segment",
				},
			},
		},
		{
			...
			wantDiags: []wantDiag{
				{
					...
					Code:          PlanCodePathPolicyViolation,
					Keyword:       KeywordPathPolicy,
					MessageSubstr: "must not contain a closure placeholder",
				},
			},
		},
	}
