...
| `ACT-LEAMAS-GATE-SUMMARY-V2-DECODER01` | IN PROGRESS | Decoder implementation is under review; Git closure is not landed. |
| `ACT-LEAMAS-GATE-SUMMARY-V2-NORMALIZATION01` | PENDING | Blocked until DECODER01 closes. |
