...
func actDoctrineCompilerChecks(root string) []checks.Finding {
	...
	requiredTests := map[string][]string{
		...
		"rollback_test.go": {
			"TestCompileRollbackFailsClosedAfterMutation",
			"TestCompileRollbackEmptyTargetCleanup",
			"TestCompileRollbackRestoresRemovedManaged",
			"TestCompileRollbackPreservesSeeded",
			"TestCompileSuccessDeterministicNoInjection",
		},
		"transaction_seam_test.go": {
			"TestRollbackApplyOnlyFailure",
			"TestRollbackLstatFailureJoined",
			"TestRollbackRemoveFailureJoined",
			"TestRollbackLstatErrNotExistIgnored",
			"TestRollbackReadDirFailureJoined",
			"TestRollbackMkdirAllFailureJoined",
			"TestRollbackWriteFileFailureJoined",
			"TestRollbackErrorMessage",
		},
		"lock_test.go": {
			"TestReadLockFileRejectsDuplicates",
			"TestReadLockFileAcceptsValid",
			"TestVerifyFailsBeforeTargetWhenLockAmbiguous",
		},
		"selector_test.go": {
			"TestVerifySelectorPackCanonical",
			"TestVerifySelectorPackForeignRejected",
			"TestExplainSelectorPackForeignRejected",
			"TestVerifySelectorInferenceWorks",
			"TestSelectorExplicitProfileRetained",
			"TestCompileSelectorUsesCanonicalPack",
		},
		"compat_test.go": {
			"TestCheckCompilerCompatibility_EmptyRejected",
			"TestCheckCompilerCompatibility_DevRejected",
			"TestCheckCompilerCompatibility_UnknownRejected",
			"TestCheckCompilerCompatibility_BelowVersionRejected",
			"TestCheckCompilerCompatibility_AtVersionAccepted",
			"TestCheckCompilerCompatibility_LaterVersionAccepted",
			"TestCompileRefusesIncompatibleVersion",
			"TestVerifyRejectsIncompatibleCompilerUnderLock",
			"TestCompileSucceedsUnderCompatibleReleaseVersion",
		},
		"makecheck_test.go": {
			"TestMakeCycleDirectMultiNode",
			"TestMakeCycleLongerChain",
			"TestMakeCycleWithReachableDesiredDep",
			"TestMakeCycleContinuationSyntax",
			"TestMakeReachabilityDetectsCycle",
			"TestMakeReachabilityLongCycle",
			"TestMakeReachabilityBranchWithCycle",
		},
		"verify_test.go": {
